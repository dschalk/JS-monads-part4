...
},{"../LinkedList":100,"../Stream":103,"../disposable/dispose":133}],119:[function(require,module,exports){
...
},{"../scheduler/PropagateTask":141}],154:[function(require,module,exports){
...
exports['default'] = { monads: monads, fib: fib, driver: driver, main: main, next: next, game: game, updateCalc: updateCalc, mult: mult, add: add, product2: product2, product3: product3, product4: product4, immutable: immutable };
module.exports = exports['default'];
...
function main(sources) {
  ...
  mMmain.bnd(function () {
    ...
    return mM6.ret(mMname.x + ' successfully logged in.');
  }), mMZ13.bnd(function () {
  ...
  addOb.addD = sources.DOM.select('input#addD').events('input');
  addOb.result = (0, _most.combine)(function (a, b) {
    return a.target.value * b.target.value;
  }, addOb.addC, addOb.addD);

  var mult7$ = addOb.result.map(function (v) {
    mMt.ret(v);
    history.push(mMt);
    mMpause2.ret(0);
  });
  ...
  var mult5$ = mMmult.x.result.debounce(3200).map(function (v) {
    mM27.ret(v);
...
},{"./code.js":167,"@motorcycle/core":1,"@motorcycle/dom":74,"most":165}]},{},[168]);
